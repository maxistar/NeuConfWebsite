...
<p>
<ul>
<li>полный билет — <b>160 евро</b> (ночёвка сб-вск включена) </li>
<li> +1 — <b>70 евро</b> (без ночёвки)</li>
<li>ночёвка с пятницы на субботу (любая свободная комната, место не закрепляется) — <b>+30 евро к основному билету</b></li>
<li>VIP-пакет — <b>380 евро</b>: две ночи с 5.09 по 7.09 на двоих, отдельная запирающаяся комната на 3-м этаже, 
ужин в пятницу вечером и завтрак в субботу утром, просекко, трансфер от и до станции в дни заезда и выезда</li> 
</ul>
<p><i>с четверга 4.09 на все билеты цены выросли (уже обновлены)</i>
...
- Но если ты предпочитаешь классические наличные, напиши мне в [телеге,](http://t.me/noob001) и я дам все контакты. Я на авто и весьма мобильный по Берлину, так что мы найдём как пересечься.
